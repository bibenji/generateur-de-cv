...
$_SESSION['data']['tit'] = "Développeur Web";
$_SESSION['data']['obj'] = "Actuellement à la recherche d'un emploi, je me permets de vous faire parvenir cette candidature pour un poste au sein de votre équipe.";
