...
<html>
	...
	<body>
		...
		<div id="manuel-main">		
			<div id="manuel-text">				
				<img class="manuel-show" src="images/close.png" />
				...
				<span class="manuel-show">Reprendre la création du CV</span>
			</div>
		</div>
	
		<form method="post" action="moncv.php" id="form-main" target="_blank">
						...
						<div id="lesreglages-content" class="droite-content">
							...
							<div class="one-reglage">
								<div class="module-affmanuel">
									<p class="manuel-show">Perdu ? Consultez le mode d'emploi !</p>		
								</div>
							</div>
